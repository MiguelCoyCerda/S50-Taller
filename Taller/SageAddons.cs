...
/// </summary>
namespace sage.addons.Taller
{
    /// <summary>
    /// Clase base para el módulo Taller
    /// </summary>
    public partial class Taller : Modulo
    {
        ...
        public Taller()
        {
            ...
            this.UserControlConfigType = typeof(Visual.UserControls.TallerConfig);
            this.ModuloConfigType = typeof(Negocio.Clases.TallerConfig);
        }
